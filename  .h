...
@interface   : SCLeftSwipableViewController <SCHeaderDataSource, SCHeaderDelegate, SCPotentiallyEligibleFlowDelegate, UINavigationControllerDelegate, UITableViewDataSource, UITableViewDelegate>
{
