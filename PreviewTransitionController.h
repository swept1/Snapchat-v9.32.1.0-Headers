...
@class  i, NSString, SCCameraTimer;
...
@interface PreviewTransitionController : NSObject <UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate>
{
    ...
    SCCameraTimer *_cameraTimer;
     i *_cameraViewController;
}

@property(nonatomic) __weak  i *cameraViewController; // @synthesize cameraViewController=_cameraViewController;
